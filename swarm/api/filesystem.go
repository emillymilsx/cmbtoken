...
import (
	...
	"github.com/CoinMarketBrasil/cmbtoken/swarm/storage"
)
...
func (self *FileSystem) Upload(lpath, index string) (string, error) {
	...
	if stat.IsDir() {
		start = len(localpath)
		log.Debug(fmt.Sprintf("uploading github.com/CoinMarketBrasil/cmbtoken%sgithub.com/CoinMarketBrasil/cmbtoken", localpath))
		err = filepath.Walk(localpath, func(path string, info os.FileInfo, err error) error {
			if (err == nil) && !info.IsDir() {
				...
				if path[:start] != localpath {
					return fmt.Errorf("Path prefix of github.com/CoinMarketBrasil/cmbtoken%sgithub.com/CoinMarketBrasil/cmbtoken does not match localpath github.com/CoinMarketBrasil/cmbtoken%sgithub.com/CoinMarketBrasil/cmbtoken", path, localpath)
				}
		...
		if localpath[:start] != dir {
			return "", fmt.Errorf("Path prefix of github.com/CoinMarketBrasil/cmbtoken%sgithub.com/CoinMarketBrasil/cmbtoken does not match dir github.com/CoinMarketBrasil/cmbtoken%sgithub.com/CoinMarketBrasil/cmbtoken", localpath, dir)
		}
