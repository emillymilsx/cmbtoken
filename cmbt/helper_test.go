...
import (
	...
	"github.com/CoinMarketBrasil/cmbtokenum/consensus/cmtash"
	...
	"github.com/CoinMarketBrasil/cmbtokenum/p2p/discover"
...
func newTestProtocolManager(mode downloader.SyncMode, blocks int, generator func(int, *core.BlockGen), newtx chan<- []*types.Transaction) (*ProtocolManager, error) {
	...
	chain, _ := core.GenerateChain(gspec.Config, genesis, cmtash.NewFaker(), db, blocks, generator)
