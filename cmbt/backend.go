...
// Package cmbt implements the Ethereum protocol.
package cmbt
...
import (
	...
	"github.com/CoinMarketBrasil/cmbtoken/eth/filters"
...
// CMBtoken implements the CMBToken full node service.
type CMBToken struct {
	config      *Config
	...
	// DB interfaces
	chainDb cmbtdb.Database // Block chain database
	...
	ApiBackend *CmbtApiBackend

	miner     *miner.Miner
	gasPrice  *big.Int
	cmbtbase common.Address
...
func (s *Ethereum) Start(srvr *p2p.Server) error {
	...
	s.netRPCService = cmbtapi.NewPublicNetAPI(srvr, s.NetVersion())
