...
import (
	...
	"github.com/CoinMarketBrasil/cmbtokenum/common"
	"github.com/CoinMarketBrasil/cmbtokenum/consensus/ethash"
	"github.com/CoinMarketBrasil/cmbtokenum/core"
	"github.com/CoinMarketBrasil/cmbtokenum/core/state"
	"github.com/CoinMarketBrasil/cmbtokenum/core/types"
	"github.com/CoinMarketBrasil/cmbtokenum/core/vm"
	"github.com/CoinMarketBrasil/cmbtokenum/crypto"
	"github.com/CoinMarketBrasil/cmbtokenum/eth/downloader"
	"github.com/CoinMarketBrasil/cmbtokenum/cmbtdb"
	"github.com/CoinMarketBrasil/cmbtokenum/event"
	"github.com/CoinMarketBrasil/cmbtokenum/p2p"
	"github.com/CoinMarketBrasil/cmbtokenum/params"
)
...
func testGetNodeData(t *testing.T, protocol int) {
	...
	generator := func(i int, block *core.BlockGen) {
		switch i {
		case 0:
			// In block 1, the test bank sends account #1 some cmbt.
			...
			block.AddTx(tx)
		case 1:
			// In block 2, the test bank sends some more cmbt to account #1.
	...
	hashes := []common.Hash{}
	for _, key := range pm.chaindb.(*cmbtdb.MemDatabase).Keys() {
	...
	statedb, _ := cmbtdb.NewMemDatabase()
