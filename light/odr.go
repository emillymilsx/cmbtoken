...
func (req *TrieRequest) StoreResult(db cmbt.Database) {
	req.Proof.Store(db)
}
...
// StoreResult stores the retrieved data in local database
func (req *CodeRequest) StoreResult(db cmbt.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BlockRequest) StoreResult(db cmbt.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ReceiptsRequest) StoreResult(db cmbt.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ChtRequest) StoreResult(db cmbt.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BloomRequest) StoreResult(db cmbt.Database) {
