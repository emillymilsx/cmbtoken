...
import (
	...
	"github.com/CoinMarketBrasil/cmbtoken/consensus/ethash"
	...
	"github.com/CoinMarketBrasil/cmbtoken/crypto"
...
type testOdr struct {
	OdrBackend
	sdb, ldb cmbt.Database
	disable  bool
}

func (odr *testOdr) Database() cmbt.Database {
	return odr.ldb
}
...
type odrTestFn func(ctx context.Context, db cmbt.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error)

func TestOdrGetBlockLes1(t *testing.T) { testChainOdr(t, 1, odrGetBlock) }

func odrGetBlock(ctx context.Context, db cmbt.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error) {
...
func odrGetReceipts(ctx context.Context, db cmbt.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error) {
...
func odrAccounts(ctx context.Context, db cmbt.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error) {
...
func odrContractCall(ctx context.Context, db cmbt.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error) {
...
func testChainOdr(t *testing.T, protocol int, fn odrTestFn) {
	var (
		sdb, _  = cmbt.NewMemDatabase()
		ldb, _  = cmbt.NewMemDatabase()
