...
import (
	...
	"github.com/CoinMarketBrasil/cmbtoken/eth"
...
type accessTestFn func(db cmbt.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes1(t *testing.T) { testAccess(t, 1, tfBlockAccess) }

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }

func tfBlockAccess(db cmbtbd.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db cmbtbd.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db cmbtbd.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db cmbtbd.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func testAccess(t *testing.T, protocol int, fn accessTestFn) {
	...
	db, _ := cmbtbd.NewMemDatabase()
	ldb, _ := cmbtbd.NewMemDatabase()
