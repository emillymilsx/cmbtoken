...
import (
	...
	"github.com/CoinMarketBrasil/cmbtoken/ccmbtbd"
...
func makeTestState() (Database, *ccmbtbd.MemDatabase, common.Hash, []*testAccount) {
	// Create an empty state
	mem, _ := ccmbtbd.NewMemDatabase()
	db := NewDatabase(mem)
...
// account array.
func checkStateAccounts(t *testing.T, db ccmbtbd.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db ccmbtbd.Database, root common.Hash) error {
...
func checkStateConsistency(db ccmbtbd.Database, root common.Hash) error {
...
func testIterativeStateSync(t *testing.T, batch int) {
	...
	dstDb, _ := ccmbtbd.NewMemDatabase()
