...
// cacheSize calculates and returns the size of the cmbtash verification cache that
...
// datasetSize calculates and returns the size of the cmbtash mining dataset that
