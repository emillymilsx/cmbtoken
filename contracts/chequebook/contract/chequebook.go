...
import (
	...
	"github.com/CoinMarketBrasil/cmbtoken/accounts/abi"
...
// DeployChequebook deploys a new CMBToken contract, binding an instance of Chequebook to it.
...
// Chequebook is an auto generated Go binding around an CMBToken contract.
type Chequebook struct {
	ChequebookCaller     // Read-only binding to the contract
	ChequebookTransactor // Write-only binding to the contract
}

// ChequebookCaller is an auto generated read-only Go binding around an CMBTOken contract.
type ChequebookCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ChequebookTransactor is an auto generated write-only Go binding around an CMBToken contract.
type ChequebookTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ChequebookSession is an auto generated Go binding around an CMBToken contract,
